        ...
        <View style={styles.container}>
            ...
            >
                ...
                >
                    ...
                    {startPoint && <Marker coordinate={startPoint} title={t('common.actions.start')} pinColor="green" />}
                    {endPoint && <Marker coordinate={endPoint} title={t('exercise.finish')} pinColor="red" />}
                </MapView>
