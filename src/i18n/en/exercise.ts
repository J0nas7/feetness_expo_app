export default {
  ...
  summaryStats: { showPrimary: 'Show primary workout stats', showMore: 'Show more workout stats', workoutDate: 'Workout date', startTime: 'Start time', totalTime: 'Total time' },
